...
public class ProductMain {
	...
	public static void main(String[] args) {
		...
		ProductService productService = new ProductService(productDAO);  // DAO object to interact with DB
		...
		ProductController control = new ProductController(productService);  // Controller initialization
		int choice;
		String choice1;
